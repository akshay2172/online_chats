...
export class ReactMessageDto extends RoomMessageDto { @IsString() @MaxLength(10) emoji: string; @IsEnum(['add','remove']) action: 'add'|'remove'; }
export class MarkAsReadDto extends RoomMessageDto {}
export class MarkRoomAsReadDto extends RoomDto {}
...
export class UploadFileDto extends RoomDto { @ValidateNested() @Type(() => FileDataDto) fileData: FileDataDto; }
export class ReportMessageDto extends RoomMessageDto { @IsOptional() @IsString() @MaxLength(1000) reason?: string; }
...
export class DeleteRoomDto { @IsString() @MaxLength(128) @Matches(ID) roomId: string; }
...
export class StartDmDto { @IsString() @MaxLength(50) @Matches(USER) targetUsername: string; }
export class SendDmMessageDto extends ConversationDto { @IsString() @IsNotEmpty() @MaxLength(10000) message: string; @IsString() @MaxLength(50) @Matches(USER) receiver: string; @IsOptional() @IsString() @MaxLength(30) messageType?: string; @IsOptional() @ValidateNested() @Type(() => FileDataDto) fileData?: FileDataDto; @IsOptional() @IsString() @MaxLength(128) @Matches(ID) replyTo?: string; }
